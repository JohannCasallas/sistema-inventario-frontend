...
import { IUsuarioAutenticacion } from '../components/interfaces/IUsuarioAutenticacion';
...
const UsuarioService = {
    ...
    async autenticarUsuario(usuario: IUsuarioAutenticacion): Promise<IRespuesta<string>> {
        try {
